                                ...
                                <div class="widget-main">
                                    ...
                                    <form id="registerForm">
                                        <fieldset>
                                            ...
                                            <label class="block clearfix">
                                                    <span class="block input-icon input-icon-right">
                                                        <input name="rePassword" type="password" class="form-control" placeholder="再次确认密码" />
                                            ...
                                            <div class="clearfix">
                                                <button id="btnResert" type="reset" class="width-30 pull-left btn btn-sm">
