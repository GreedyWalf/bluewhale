    ...
    <div class="col-xs-12">
        ...
        <div class="clearfix">
            <div class="pull-left alert alert-success no-margin">
                ...
                对自己头像不满意，点击图片可以更新切换头像哦！
            </div>

            <div class="pull-right">
                <span class="green middle bolder">切换风格: &nbsp;</span>
                    ...
                    <div class="profile-user-info profile-user-info-striped">
                        ...
                        <div class="profile-info-row">
                            ...
                            <div class="profile-info-value">
                                ...
                                <span class="editable" id="city">杭州</span>
                            </div>
                        </div>
                        ...
                        <div class="profile-info-row">
                            <div class="profile-info-name"> 最近一次上线</div>
                        ...
                        <div class="profile-info-row">
                            ...
                            <div class="profile-info-value">
                                <span class="editable" id="about">Just Do IT</span>
                            </div>
                        </div>
                    </div>
        ...
        try {
            ...
            $('#userHeadImg').editable({
                ...
                url: function (params) {
                    ...
                    //如果value的值为空，表示没有可选择的图片文件
                    var value = $('#userHeadImg').next().find('input[type=hidden]:eq(0)').val();
                    ...
                    setTimeout(function () {
                        if ("FileReader" in window) {
                            ...
                            var thumb = $('#userHeadImg').next().find('img').data('thumb');
